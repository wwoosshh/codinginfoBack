...
router.post('/articles', adminController_1.createArticle);
router.get('/articles/:id', adminController_1.getArticleById);
router.put('/articles/:id', adminController_1.updateArticle);
...
router.get('/categories/stats', categoryController_1.getCategoryStats);
